...
const formatInstructions = Mustache.render(
  `'The output must be JSON and JSON only! Here is an example of a valid JSON output:
{{validJson}}'`,
  {
...
Requested changes: {{requestedChanges}}`,
  ...
  async _getCompletion({ systemPrompt, userPrompt }) {
    ...
    // TODO: Replace with prediction from Bedrock
